...
%       for 39-bus system.
%   NOTE BY HAFEZ: this is the original matpower case file
...
% Machine data format (from PST/pstdat/d2asbegp)
%       1. machine number,
%       2. bus number,
%       3. base mva,
...
% Since the voltage base is not given, pu values are used.
...
mpc.mac_con = [
  ...
  10 39  1000.0 0.030 0.0010  0.200 0.060 0 7.000 0 0.190 0.060 0  0.700 0 5.00 0.000 0.00 39 0 0];
